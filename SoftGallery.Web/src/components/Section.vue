        ...
        <div class="container">
            <div class="header">
                <div class="header-text">
                    ...
                    <p class="descricao">
                        Os produtos mais recentes da loja
                    </p>
                </div>
...
export default {
  ...
  },
  {
    ...
    precoDesconto: 279.90,
    desconto: "20",
    avaliacao: 4.2
  },
  {
    nome: "Notebook Ultra Slim",
    precoOriginal: 3999.00,
    precoDesconto: 2999.00,
    desconto: "25",
    avaliacao: 4.8
  },
  {
