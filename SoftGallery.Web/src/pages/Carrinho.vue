                    ...
                    <div v-for="p in carrinho" class="p-8 hover:bg-gray-50/50 transition-all duration-200">
                        <div class="flex items-center space-x-6">
                            ...
                            <div class="min-h-10 flex flex-col items-center">
                                ...
                                <button @click="deleteProduto(p.id)" class="flex justify-between gap-3 bg-red-100 p-2 rounded-lg font-medium items-center text-red-400 text-sm hover:scale-110 transform transition duration-200 hover:shadow cursor-pointer"><i class="fa-solid fa-trash "></i> Remove</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div v-else="carrinho.length" class="shadow-white/50 shadow-md rounded-3xl border border-white/20 col-span-2  overflow-hidden ">
